...
void arr(int player_num[8], int pos[8], int rest[2], int count[6], int vote_result[6]);
...
void game(int i, int j, int nop, int vote, int (*player_num), int (*count), int (*vote_result), int (*pos))
{
    printf("議論時間が終了しました。これから投票時間に移ります。\n");
        ...
        if(nop==5)
        {
            ...
            {
                printf("投票の結果、player%dを処刑しました。\n", player_num[5]);
                if(pos[5]!=3 && pos[5]!=4 && (pos[1]==3 || pos[1]==4 || pos[2]==3 || pos[2]==4 || pos[3]==3 || pos[3]==4 || pos[4]==3 || pos[4]==4))
                printf("人狼チームの勝利です。\n");
            ...
            if(count[4]==count[5] && count[4]>count[1] && count[4]>count[2] && count[4]>count[3])
            {
                ...
                if((pos[4]!=3 && pos[4]!=4) && (pos[5]!=3 && pos[5]!=4) && (pos[1]==3 || pos[1]==4 || pos[2]==3 || pos[2]==4 || pos[3]==3 || pos[3]==4))
                printf("人狼チームの勝利です。\n");
        ...
        if(nop==6)
        {
            ...
            if(count[1]==count[4] && count[1]>count[2] && count[1]>count[3] && count[1]>count[5] && count[1]>count[6])
            {
                printf("投票の結果、player%dとplayer%dを処刑しました。\n", player_num[1], player_num[4]);
            ...
            if(count[1]==count[5] && count[1]>count[2] && count[1]>count[3] && count[1]>count[4] && count[1]>count[6])
            {
                printf("投票の結果、player%dとplayer%dを処刑しました。\n", player_num[1], player_num[5]);
            ...
            if(count[1]==count[6] && count[1]>count[2] && count[1]>count[3] && count[1]>count[4] && count[1]>count[5])
            {
                ...
                if((pos[1]!=3 && pos[1]!=4  && pos[1]!=8  && pos[6]!=3 && pos[6]!=4 && pos[6]!=8) && (pos[2]==3 || pos[2]==4 || pos[3]==3 || pos[3]==4 || pos[4]==3 || pos[4]==4 || pos[5]==3 || pos[5]==4))
                printf("人狼チームの勝利です。\n");
            ...
            {
                printf("投票の結果、player%dとplayer%dを処刑しました。\n", player_num[2], player_num[5]);
                if((pos[2]!=3 && pos[2]!=4 && pos[2]!=8 && pos[5]!=3 && pos[5]!=4 && pos[5]!=8) && (pos[1]==3 || pos[1]==4 || pos[3]==3 || pos[3]==4 || pos[4]==3 || pos[4]==4 || pos[6]==3 || pos[6]==4))
                printf("人狼チームの勝利です。\n");
            ...
            if(count[2]==count[6] && count[2]>count[1] && count[2]>count[3] && count[2]>count[4] && count[2]>count[5])
            {
                ...
                if((pos[2]!=3 && pos[2]!=4 && pos[2]!=8 && pos[6]!=3 && pos[6]!=4 && pos[6]!=8) && (pos[1]==3 || pos[1]==4 || pos[3]==3 || pos[3]==4 || pos[4]==3 || pos[4]==4 || pos[5]==3 || pos[5]==4))
                printf("人狼チームの勝利です。\n");
            ...
            if(count[4]==count[5] && count[4]>count[1] && count[4]>count[2] && count[4]>count[3] && count[4]>count[6])
            {
                ...
                printf("人狼チームの勝利です。\n");
                else if((pos[4]==3 || pos[4]==4 || pos[5]==3 || pos[5]==4) && pos[4]!=8 && pos[5]!=8)
                printf("村人チームの勝利です。\n");
            ...
            if(count[1]==count[2] && count[1]==count[4] && count[1]>count[3] && count[1]>count[5] && count[1]>count[6])
            {
            ...
            if(count[1]==count[2] && count[1]==count[5] && count[1]>count[3] && count[1]>count[4] && count[1]>count[6])
            {
            ...
            if(count[1]==count[2] && count[1]==count[6] && count[1]>count[3] && count[1]>count[4] && count[1]>count[5])
            {
            ...
            if(count[1]==count[3] && count[1]==count[4] && count[1]>count[2] && count[1]>count[5] && count[1]>count[6])
            {
            ...
            if(count[1]==count[3] && count[1]==count[5] && count[1]>count[2] && count[1]>count[4] && count[1]>count[6])
            {
            ...
            if(count[1]==count[3] && count[1]==count[6] && count[1]>count[2] && count[1]>count[4] && count[1]>count[5])
            {
            ...
            if(count[1]==count[4] && count[1]==count[5] && count[1]>count[2] && count[1]>count[3] && count[1]>count[6])
            {
            ...
            if(count[1]==count[4] && count[1]==count[6] && count[1]>count[2] && count[1]>count[3] && count[1]>count[5])
            {
            ...
            if(count[1]==count[5] && count[1]==count[6] && count[1]>count[2] && count[1]>count[3] && count[1]>count[4])
            {
            ...
            if(count[2]==count[3] && count[2]==count[4] && count[2]>count[1] && count[2]>count[5] && count[2]>count[6])
            {
            ...
            if(count[2]==count[3] && count[2]==count[5] && count[2]>count[1] && count[2]>count[4] && count[2]>count[6])
            {
            ...
            if(count[2]==count[3] && count[2]==count[6] && count[2]>count[1] && count[2]>count[4] && count[2]>count[5])
            {
            ...
            if(count[2]==count[4] && count[2]==count[5] && count[2]>count[1] && count[2]>count[3] && count[2]>count[6])
            {
            ...
            if(count[2]==count[4] && count[2]==count[6] && count[2]>count[1] && count[2]>count[3] && count[2]>count[5])
            {
            ...
            if(count[2]==count[5] && count[2]==count[6] && count[2]>count[1] && count[2]>count[3] && count[2]>count[4])
            {
            ...
            if(count[3]==count[4] && count[3]==count[5] && count[3]>count[1] && count[3]>count[2] && count[3]>count[6])
            {
            ...
            if(count[3]==count[4] && count[3]==count[6] && count[3]>count[1] && count[3]>count[2] && count[3]>count[5])
            {
            ...
            if(count[3]==count[5] && count[3]==count[6] && count[3]>count[1] && count[3]>count[2] && count[3]>count[4])
            {
            ...
            if(count[4]==count[5] && count[4]==count[6] && count[4]>count[1] && count[4]>count[2] && count[4]>count[3])
            {
